#Script Extinciones con umbral y ordenadas según orden creciente y decreciente
...
#necesito identificar a los productores para no eliminarlos
S <- length(red)
...
#necesito pegar el vector umbral para poder extinguirlas
A <- rbind(red,vectorumbral)

#extinción primaria

for (x in 1:S){#en el caso NTcreciente lo voy a tener que cortar antes porque colapsa todo entonces cambie el loop hasta 30.
if(length(A)>9 & sum(A)!=0){ #mayor a 9 porque Vane habia puesto un corte del 10%
B <- A[-1,]
A <- B[,-1]

#necesito encontrar las extinciones secundarias
...
#corro dos veces y me guardo la lista de ext con umbral para cada orden
#NetCre<-Net
#NetDec<-Net
...
#save.image("~/Documentos/Extinciones Vane Salinas/Umbrales1.RData")
#####

dev.new()
#svg(filename="QSSUmbrales_CREC.svg", width=10)
par(mfrow=c(2,2))
#plot(seq(1:74), NetCre1.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1, main= "Umbral 0.1", xlim=c(1,75))
plot(seq(1:74), NetCre2.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1,  main= "Umbral 0.2", xlim=c(1,75))
#plot(seq(1:68), NetCre3.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1,  main= "Umbral 0.3", xlim=c(1,75))
plot(seq(1:66), NetCre4.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1, main="Umbral 0.4", xlim=c(1,75))
#plot(seq(1:62), NetCre5.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1 , main="Umbral 0.5", xlim=c(1,75))
plot(seq(1:61), NetCre6.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1, main="Umbral 0.6", xlim=c(1,75))
#plot(seq(1:56), NetCre7.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1, main="Umbral 0.7", xlim=c(1,75))
plot(seq(1:52), NetCre8.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1,  main="Umbral 0.8", xlim=c(1,75))
#plot(seq(1:51), NetCre9.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1, main="Umbral 0.9", xlim=c(1,75))
dev.off()

dev.new()
#svg(filename="MEingUmbrales_CREC.svg", width=10)
par(mfrow=c(2,2))
#plot(seq(1:74), NetCre1.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1,  main= "Umbral 0.1", xlim=c(1,75))
plot(seq(1:74), NetCre2.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1,  main= "Umbral 0.2", xlim=c(1,75))
#plot(seq(1:68), NetCre3.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1,  main= "Umbral 0.3", xlim=c(1,75))
plot(seq(1:66), NetCre4.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1, main="Umbral 0.4", xlim=c(1,75))
#plot(seq(1:62), NetCre5.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1, main="Umbral 0.5", xlim=c(1,75))
plot(seq(1:61), NetCre6.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1, main="Umbral 0.6", xlim=c(1,75))
#plot(seq(1:56), NetCre7.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1, main="Umbral 0.7", xlim=c(1,75))
plot(seq(1:52), NetCre8.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1,  main="Umbral 0.8", xlim=c(1,75))
#plot(seq(1:51), NetCre9.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1, main="Umbral 0.9", xlim=c(1,75))
dev.off()

#grafico en tres dimensiones

umbrales<-c(rep(0.1, 74), rep(0.2, 74), rep(0.3, 68), rep(0.4, 66), rep(0.5, 62), rep(0.6, 61), rep(0.7, 56), rep(0.8, 52), rep(0.9,51))
Extinciones<-c(seq(1:74), seq(1:74), seq(1:68), seq(1:66), seq(1:62), seq(1:61), seq(1:56), seq(1:52), seq(1:51))
netCRE<- rbind(NetCre1.QSS, NetCre2.QSS, NetCre3.QSS, NetCre4.QSS, NetCre5.QSS, NetCre6.QSS, NetCre7.QSS, NetCre8.QSS, NetCre9.QSS)
nnetCRE<-data.frame(netCRE, umbrales, Extinciones)

library(plotly)

p <- plot_ly(nnetCRE, x=~Extinciones, y=~QSS, 
             z=~umbrales, color=~umbrales) %>%
  add_markers(size=1) 
print(p)
...
dev.new()
#svg(filename="QSSUmbrales_DEC.svg", width=10)
par(mfrow=c(2,2))
#plot(seq(1:29), NetDec1.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1, main= "Umbral 0.1", xlim=c(1,30))
plot(seq(1:24), NetDec2.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1,  main= "Umbral 0.2", xlim=c(1,30))
#plot(seq(1:22), NetDec3.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1,  main= "Umbral 0.3", xlim=c(1,30))
plot(seq(1:18), NetDec4.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1, main="Umbral 0.4", xlim=c(1,30))
#plot(seq(1:16), NetDec5.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1 , main="Umbral 0.5", xlim=c(1,30))
plot(seq(1:15), NetDec6.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1, main="Umbral 0.6", xlim=c(1,30))
#plot(seq(1:14), NetDec7.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1, main="Umbral 0.7", xlim=c(1,30))
plot(seq(1:13), NetDec8.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1,  main="Umbral 0.8", xlim=c(1,30))
#plot(seq(1:11), NetDec9.QSS$QSS, xlab="Extinctions", ylab= "Quasi Sign-Stability", pch = 19, cex = 1, main="Umbral 0.9", xlim=c(1,30))
dev.off()

dev.new()
#svg(filename="MEingUmbrales_DEC.svg", width=10)
par(mfrow=c(2,2))
#plot(seq(1:29), NetDec1.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1,  main= "Umbral 0.1", xlim=c(1,30))
plot(seq(1:24), NetDec2.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1,  main= "Umbral 0.2", xlim=c(1,30))
#plot(seq(1:22), NetDec3.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1,  main= "Umbral 0.3", xlim=c(1,30))
plot(seq(1:18), NetDec4.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1, main="Umbral 0.4", xlim=c(1,30))
#plot(seq(1:16), NetDec5.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1, main="Umbral 0.5", xlim=c(1,30))
plot(seq(1:15), NetDec6.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1, main="Umbral 0.6", xlim=c(1,30))
#plot(seq(1:14), NetDec7.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1, main="Umbral 0.7", xlim=c(1,30))
plot(seq(1:13), NetDec8.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1,  main="Umbral 0.8", xlim=c(1,30))
#plot(seq(1:11), NetDec9.QSS$MEing, xlab="Extinctions", ylab= "MEing", pch = 19, cex = 1, main="Umbral 0.9", xlim=c(1,30))
dev.off()

#grafico en tres dimensiones

umbralesD<-c(rep(0.1, 29), rep(0.2, 24), rep(0.3, 22), rep(0.4, 18), rep(0.5, 16), rep(0.6, 15), rep(0.7, 14), rep(0.8, 13), rep(0.9,11))
ExtincionesD<-c(seq(1:29), seq(1:24), seq(1:22), seq(1:18), seq(1:16), seq(1:15), seq(1:14), seq(1:13), seq(1:11))
netDEC<- rbind(NetDec1.QSS, NetDec2.QSS, NetDec3.QSS, NetDec4.QSS, NetDec5.QSS, NetDec6.QSS, NetDec7.QSS, NetDec8.QSS, NetDec9.QSS)
nnetDEC<-data.frame(netDEC, umbralesD, ExtincionesD)

library(plotly)

p <- plot_ly(nnetDEC, x=~ExtincionesD, y=~QSS, 
             z=~umbralesD, color=~umbralesD) %>%
  add_markers(size=1) 
print(p)
...
NetCre9.Top<- data.frame() #para hacerlos todos tengo que ir cambiando el número lo mejor sería hacerlo en una función pero ahora lo voy a hacer a mano.
...
p2 <- plot_ly(TopCRE, x=~Extinciones, y=~Omnivory, 
             z=~umbrales, color=~umbrales) %>%
  add_markers(size=1) 
print(p2)

p3 <- plot_ly(TopCRE, x=~Extinciones, y=~Clustering, 
              z=~umbrales, color=~umbrales) %>%
  add_markers(size=1) 
print(p3)

p4 <- plot_ly(TopCRE, x=~Extinciones, y=~PathLength, 
              z=~umbrales, color=~umbrales) %>%
  add_markers(size=1) 
print(p4)

##### En orden decreciente ####
NetDec9.Top<- data.frame() #para hacerlos todos tengo que ir cambiando el número lo mejor sería hacerlo en una función pero ahora lo voy a hacer a mano.
...
p5 <- plot_ly(TopDEC, x=~ExtincionesD, y=~Omnivory, 
              z=~umbralesD, color=~umbralesD) %>%
  add_markers(size=1) 
print(p5)

p6 <- plot_ly(TopDEC, x=~ExtincionesD, y=~Clustering, 
              z=~umbralesD, color=~umbralesD) %>%
  add_markers(size=1) 
print(p6)

p7 <- plot_ly(TopDEC, x=~ExtincionesD, y=~PathLength, 
              z=~umbralesD, color=~umbralesD) %>%
  add_markers(size=1) 
print(p7)

#####Modularidad por grado creciente y decreciente#####

#para calcular la modularidad tengo que eliminar los vertices con grado = 0. Para eso se puede usar la funcion de igraph delete.vertex
...
#tengo que probar que este loop no la esta flasheando.

print(calc_modularity(ModNet[[1]][[1]]))

Isolated = which(degree(NetDec1[[1]])==0)
G2 = delete.vertices(NetDec1[[1]], Isolated)
print(calc_modularity(G2)) #me da exactamente lo mismo asi que deberia estar bien. 
...
#Tengo que hacer lo mismo para el orden creciente
...
dev.new()
#svg(filename="ModDec.svg", width=10)
par(mfrow=c(2,2))
...
dev.new()
#svg(filename="ModCre.svg", width=10)
par(mfrow=c(2,2))
...
##### Extinciones por nivel trófico####

redNTdec <- read.csv("NTdec.csv", header=T, row.names=1)
redNTcre <- read.csv("NTcre.csv", header=T, row.names=1)

red<-redNTdec #para correr el script de arriba 
red<-redNTcre #vuelvo a correr los scripts de arriba pero con esta nueva red.
...
#save.image("~/Documentos/Extinciones Vane Salinas/NTqss19062023.RData")

dev.new()
#svg(filename="QSSUmbrales_CREC_NT.svg", width=10)
par(mfrow=c(2,2))
...
dev.new()
#svg(filename="QSSUmbrales_DEC_NT.svg", width=10)
par(mfrow=c(2,2))
...
#Tengo que repetir las lineas anteriores pero con la función de calc_topological_indices para chequear si las métricas estan bien.

#Métricas topológicas extinciones NT creciente
...
#La única base que queda es el fitoplancton que tiene un grado alto por eso termina con un L bastante grande la red.

#Métricas topológicas extinciones NT decreciente
...
#####Mod por ext de NT#####
###Tengo que calcular la modularidad y para eso necesito eliminar los nodos sueltos#
...
dev.new()
#svg(filename="ModDecNT.svg", width=10)
par(mfrow=c(2,2))
